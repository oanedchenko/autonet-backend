...
//go:generate swagger generate server --target .. --name  --spec ../autonet.yaml

func configureFlags(api *operations.AutonetAPIDocumentationAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.AutonetAPIDocumentationAPI) http.Handler {
